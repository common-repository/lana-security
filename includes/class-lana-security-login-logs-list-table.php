...
class Lana_Security_Login_Logs_List_Table extends WP_List_Table {
	...
	public function __construct() {
		...
		parent::__construct( array(
			'singular' => 'lana_security_login_log',
			'plural'   => 'lana_security_login_logs',
			'ajax'     => false
		) );
	...
	public function column_status( $item ) {
		...
		return sprintf( __( '(status code: %d)', 'lana-security' ), $item->status );
	}
	...
	public function prepare_items() {
		...
		$per_page     = $this->get_items_per_page( 'lana_security_login_logs_per_page' );
	...
	public function process_bulk_action() {
		...
		$log_ids = isset( $_REQUEST['lana_security_login_log'] ) ? wp_parse_id_list( wp_unslash( $_REQUEST['lana_security_login_log'] ) ) : array();
